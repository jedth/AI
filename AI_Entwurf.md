...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>DeviceCatalog: stellt die für die Bewertung benötigten Regeln bereit (getRules)<br>ProductManager: kann die Erstellung von Bewertungen anfragen (createReview)</td>
        </tr>
        <tr>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            <td>Schnittstellen</td>
            <td>
                <li>ReviewService: greift auf die gespeicherten Regeln zu einem Gerätetypen zu (getRules)<br></li>
                <li>ProductManager: kann anfragen, ob ein Gerät unterstützt wird (isSupportedType)<br></li>
                <li>ProductManager: kann Unterstützung eines neuen Gerätetyps anfragen (addSupportedType)<br></li>
                <li>DeviceDatabase: stellt Daten zu den Gerätetypen bereit (z.B. getNumberOfDevices)<br></li>
